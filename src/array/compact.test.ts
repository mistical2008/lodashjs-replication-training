...
describe('compact():', () => {
  compareArrays(
    compact, [array] as Params, arrayCompact,
  );
  compareArrays(
    compact, [array2] as Params, arrayCompact2,
  );
  compareArrays(
    compact, [array3] as Params, arrayCompact3,
  );
  compareArrays(
    compact, [array4] as Params, arrayCompact4,
  );
});
